...
function KeyChange(key) { 
	...
	if (intn.selectedIndex==0)	Intonation = 'Just';
	if (intn.selectedIndex==1)	Intonation = 'HB-trad';
	//if (int.selectedIndex==2) Intonation = 'HB-2';
	if (intn.selectedIndex==2) Intonation = 'ET';	
	// intonation arrays
...
function Calculate() {
	...
	// get input data from form fields
		...
		Ff[1]= fluteForm.freq1.value; if(Ff[1]==0) Df[1] = 0;
		Ff[2]= fluteForm.freq2.value; if(Ff[2]==0) Df[2] = 0;
		Ff[3]= fluteForm.freq3.value; if(Ff[3]==0) Df[3] = 0;
		Ff[4]= fluteForm.freq4.value; if(Ff[4]==0) Df[4] = 0;
		Ff[5]= fluteForm.freq5.value; if(Ff[5]==0) Df[5] = 0;
		Ff[6]= fluteForm.freq6.value; if(Ff[6]==0) Df[6] = 0;
		Ff[7]= fluteForm.freq7.value; if(Ff[7]==0) Df[7] = 0;
    ...
    // output to form fields
		...
		fluteForm.resultLength.value = ( parseFloat(TipLength/K) + Math.round(R/K*(Xend-Xemb))/R )+U;
...
{
	if (n==0) return "key ";
	else if(n < 240) return "Bass ";
	else if (n < 425) return "Low ";
 	else return "";
}
